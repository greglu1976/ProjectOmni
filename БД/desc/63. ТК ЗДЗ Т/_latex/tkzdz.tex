...
\item
В зависимости от положения переключателя SGF2 <<Режим контроля тока>> функция <<ТК ЗДЗ>> контролирует:
\begin{itemize} 
\item повышение любого фазного тока (\textsl{IA, IB, IC}) стороны ВН трансформатора выше заданной уставки, при превышении заданной уставки выдается пусковой сигнал для выдачи в цепи дуговых защит секций НН трансформатора;
