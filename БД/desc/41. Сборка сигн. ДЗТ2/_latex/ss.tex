...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% СБОРКА СИГНАЛОВ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item
Сборка сигналов используется в качестве дополнительной логики для предупредительной сигнализации, которая описана в подразделе \ref{ps:punkt}.

\item
В устройстве сборка сигналов представлена функциональным блоком «СС».

\item
Функциональный блок «СС» принимает различные сигналы от других функций и формирует следующие обобщенные сигналы:
\begin{itemize}
...
\caption{Параметры для настройки сборки сигналов\hfill\vspace{-0.5\baselineskip}}\label{ss:tbl1}\\ 
\hline
\rowcolor{gray!30}
