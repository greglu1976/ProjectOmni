...
\item
В устройстве токовые органы пуска охлаждения трансформатора представлены функциональным блоком «РТПО». Функциональный блок «РТПО» имеет в своем составе функции контроля тока по каждой из трех сторон трансформатора 35 кВ (ТО ВН, ТО НН1, ТО НН2). 
