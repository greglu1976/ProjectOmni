...
\hline
\centering Контроль положения переключателя аварийной деблокировки (Контр\_пол\_ав\_дебл) & \centering SGF7 & \centering 0 = Не предусмотрено\\1 = Предусмотрено & \centering -- & \centering \arraybackslash -- \\
\hline
%===t1
\end{longtable}
\normalsize
