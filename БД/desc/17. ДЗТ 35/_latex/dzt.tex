...
\item
Алгоритм работы функции выполнен в соответствии с рисунком \ref{dzt:img1}. В таблице \ref{dzt:tbl1} приведены параметры, необходимые для настройки функции.
...
\item при пропадании условий срабатывания функции от смежных фаз или по истечению времени «Tперек\_блок» должно осуществляться блокирование срабатывания ДТЗт пофазно.
\end{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{\fbpath/17. ДЗТ 35/_latex/img/kzt.pdf}
