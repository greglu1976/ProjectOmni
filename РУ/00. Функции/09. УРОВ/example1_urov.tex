% Расчет уставок УРОВ для Т менее 6,3 МВА
...
\begin{equation*}
    I_{\textsl{с.з.}} = 0,1 \cdot I_{\textsl{ном,в}} = 0,1 \cdot 62,4 = 6,2\; (\textsl{А})  ,
\end{equation*}
\begin{eqexpl}[15mm]
...
\begin{equation*}
    I_{\textsl{ср}} = \frac{I_{\textsl{с.з.}}}{I_{\textsl{ном.вх.уст}}} \cdot \frac{I_{\textsl{ном.вт.ТТ}}}{I_{\textsl{ном.пер.ТТ}}} = \frac{6,2}{5} \cdot \frac{5}{600} = 0,01\; (\textsl{о.е.}),
\end{equation*}
\begin{eqexpl}[15mm]
...
\item
Так как минимально возможное значение для параметра <<Ток срабатывания>> функции УРОВ это 0,05, то параметр \textbf{$I_{\textsl{ср}}$} <<Ток срабатывания>> функции УРОВ принимается равным минимальному, т.е. \textbf{0,05}.
\item
