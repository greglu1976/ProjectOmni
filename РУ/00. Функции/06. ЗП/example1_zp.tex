% Выбор уставок для Т менее 6,3 МВА

\item \textbf{Выбор уставок защиты от перегрузки}
...
\begin{equation*}
    I_{\textsl{с.з.ЗП}} = \frac{K_{\textsl{отс}}}{K_{\textsl{в}}} \cdot I_{\textsl{ном.ст.}} = \frac{1,05}{0,95} \cdot 62,4 = 69\; (\textsl{А}),
\end{equation*}
...
\begin{equation*}
    I_{\textsl{ср}} = \frac{I_{\textsl{с.з.ЗП}}}{I_{\textsl{ном.вх.уст}}} \cdot \frac{I_{\textsl{ном.вт.ТТ}}}{I_{\textsl{ном.пер.ТТ}}} = \frac{69}{5} \cdot \frac{5}{600} = 0,11\; (\textsl{о.е.}),
\end{equation*}
\begin{eqexpl}[15mm]
...
\item
Параметр \textbf{$I_{\textsl{ср}}$} <<Ток срабатывания>> функции ЗП принимается \textbf{равным 0,11}.
\item
