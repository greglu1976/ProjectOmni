...
%===m>Фиксация положения выключателя В1|ФПВ В1
\raggedright {'Description': ''} & \centering Programmnyj_klyuch_1_s & \centering Введено \\ Выведено & \centering --- & \centering \arraybackslash --- \\
\hline
\raggedright {'Description': ''} & \centering Pereklyuchatel_Vkh_2_bool_const_1_S & \centering 0 ... 65535 & \centering  & \centering \arraybackslash 1 \\
\hline
%===m
\end{longtable}
\normalsize
