{\color{uniblue}\section[(обязательное) Схема электрическая соединений рядов зажимов]{(обязательное)\\Схема электрическая соединений рядов зажимов}\label{app:a41}}
\color{black}
