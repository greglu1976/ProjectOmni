...
\def\ManualTechSpec{ТУ 27.12.31-304-61775353-2025 «Низковольтные комплектные устройства систем защиты и автоматики серии ШЭТ»}
\def\ManualUnitGeneral{ЮТКБ.656122.611 РЭ «Устройства защиты и автоматики серии ЮНИТ-М500»}
%\def\ManualUnitHMI{ЮТКБ.656132.701 РЭ «Блок интерфейсный ЮНИТ-ИЧМ»}
%\def\ManualUnitSRZA{RU.37182817.00001.02.34.01 «Программное обеспечение мониторинга и параметрирования ЮНИТ-СЕРВИС-РЗА»}
%\def\ManualUnitMU{ЮТКБ.656122.611 ИС – «Устройства защиты и автоматики серии ЮНИТ-М500. Инструкция эксплуатационная специальная. Методические указания по выполнению технического обслуживания»}