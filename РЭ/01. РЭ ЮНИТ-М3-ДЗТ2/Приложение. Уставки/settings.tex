...
\hline
\centering Выдержка времени срабатывания (Tср)  & \centering T1 & \centering 0...110000 & \centering мс & \centering \arraybackslash 100 \\
\hline
%===t1
\end{longtable}
\normalsize
...
\hline
\centering Минимальное значение фазного тока (Iмин)  & \centering Iмин< & \centering 0,250...5,000 & \centering А (вторич.) & \centering \arraybackslash 0,001 \\
\hline
\centering Коэффициент симметрии (Kсим)  & \centering Iмин/Iмакс< & \centering 0,10...0,95 & \centering -- & \centering \arraybackslash 0,01 \\
\hline
\centering Минимальная величина максимального из фазных токов (LIсим)  & \centering Iмакс> & \centering 0,050...10,000 & \centering А (вторич.) & \centering \arraybackslash 0,001 \\
\hline
\centering Выдержка времени на срабатывание по критерию обрыва фазы (Tобрыв)  & \centering T1 & \centering 0...100000 & \centering мс & \centering \arraybackslash 10 \\
\hline
\centering Выдержка времени на срабатывание по асимметрии токов (Tасим)  & \centering T2 & \centering 0...100000 & \centering мс & \centering \arraybackslash 10 \\
\hline
...
\hline
\centering Выдержка времени срабатывания (Tср)  & \centering T1 & \centering 0...3600000 & \centering мс & \centering \arraybackslash 1000 \\
\hline
%===t1
\end{longtable}
\normalsize
...
\centering Ввод функции в работу (Ввод\_функции)  & \centering SGF1 & \centering Не предусмотрено \\ Предусмотрено & \centering -- & \centering \arraybackslash -- \\
\hline
\centering Ток срабатывания (Iср)  & \centering I> & \centering 0,500...150,000 & \centering А (вторич.) & \centering \arraybackslash 0,001 \\
\hline
...
\centering Ввод функции в работу (Ввод\_функции)  & \centering SGF1 & \centering Не предусмотрено \\ Предусмотрено & \centering -- & \centering \arraybackslash -- \\
\hline
\centering Ток срабатывания (Iср)  & \centering I> & \centering 0,500...25,000 & \centering А (вторич.) & \centering \arraybackslash 0,001 \\
\hline
...
\centering Ввод функции в работу (Ввод\_функции)  & \centering SGF1 & \centering Не предусмотрено \\ Предусмотрено & \centering -- & \centering \arraybackslash -- \\
\hline
\centering Ток срабатывания (Iср)  & \centering I> & \centering 0,250...2,500 & \centering А (вторич.) & \centering \arraybackslash 0,001 \\
\hline
