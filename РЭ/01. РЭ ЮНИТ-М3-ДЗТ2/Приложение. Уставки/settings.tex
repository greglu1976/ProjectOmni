...
\caption*{\hspace{3pt}\emph{Продолжение таблицы \ref{app_set:dzt}}\hfill\ }\vspace{-0.5\baselineskip} \\
\hline
\rowcolor{gray!20}
Параметр & Условное обозначение на схеме & Значение/ Диапазон & Единица измерения & Шаг \\
\hline
...
\caption*{\hspace{3pt}\emph{Продолжение таблицы \ref{app_set:kzt}}\hfill\ }\vspace{-0.5\baselineskip} \\
\hline
\rowcolor{gray!20}
Параметр & Условное обозначение на схеме & Значение/ Диапазон & Единица измерения & Шаг \\
\hline
