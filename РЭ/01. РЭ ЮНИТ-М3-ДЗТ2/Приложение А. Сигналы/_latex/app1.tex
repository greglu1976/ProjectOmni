...
\rowcolor{gray!15}
\multicolumn{9}{c}{Слот М12. Измерительный блок (М090)} \\
\hline
\raggedright Отказ блока & \centering Слот М12. Общие сигналы. Блок модуля & \centering -- & \centering + & \centering + & \centering -- & \centering + & \centering + & \centering \arraybackslash + \\ \hline
