...
% Определяем новые цвета фирмы (зонтичный бренд 14.05.2026)
...
\titlespacing{\section}{1cm}{0pt}{7pt} %------------------------------------- 25.04.26
\titlespacing{\subsection}{1cm}{6pt}{5pt} %------------------------------------- 25.04.26
\titlespacing{\subsubsection}{1cm}{3pt}{3pt} %------------------------------------- 25.04.26
...
\setlist[itemize]{
    label=-,			 % маркер
    leftmargin=0pt,      % отступ для всех строк
    itemindent=38pt,     % отступ для первой строки
    labelsep=5pt,        % пробел между маркером и текстом
...
\usepackage{fontawesome7} % Подключить пакет шрифтов fontawesome %------------------------------------- 25.04.26
...
\usepackage{ragged2e} % пакет для выравнивания по ширине в title1

%\usepackage{showframe} %отображение границ. полезно при вёрстке для таблиц
