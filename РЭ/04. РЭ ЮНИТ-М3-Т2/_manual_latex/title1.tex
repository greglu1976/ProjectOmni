...
\begin{longtable}[l]{|>{\centering}m{4cm}|>{\centering\arraybackslash}m{4cm}|}
    ...
    \hline
    \textcolor{unigray}{1.1} & \textcolor{unigray}{18.09.2025} \\
    \hline 
    \textcolor{unigray}{\rev} & \textcolor{unigray}{\revdate} \\
    \hline 
     &  \\
    \hline
\end{longtable}
...
\vskip 70mm
\noindent
Настоящее руководство по эксплуатации относится к микропроцессорному устройству защиты и автоматики трансформатора напряжением до 35 кВ типа <<ЮНИТ-М300-Т2>>.
