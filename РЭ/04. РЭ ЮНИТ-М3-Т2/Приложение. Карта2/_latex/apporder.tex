...
\textbf{ЮНИТ-М314-Т2-
    ...
    \tikz[baseline=(char.base)]{
        \node[rectangle, fill=uniblue, text=white, inner sep=2pt] (char) {\textbf{M8}};
    } - 
    {\textbf{X}
    } -      
    \tikz[baseline=(char.base)]{
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[uniblue, very thick] (14.1+\aDelta, 7.0) -- (14.1+\aDelta, 2.6) -- (\dCoord, 2.6); % Новые координаты
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[unired, very thick] (15.3+\aDelta, 11.9) -- (15.3+\aDelta, 4.65) -- (\dCoord, 4.65); % Новые координаты
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[uniblue, very thick] (15.9+\aDelta, 12.8) -- (15.9+\aDelta, 0.7) -- (\dCoord, 0.7); % Новые координаты
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[unired, very thick] (16.4+\aDelta, 13.6) -- (16.4+\aDelta, 0.6) -- (\dCoord, 0.6); % Новые координаты
\end{tikzpicture}
