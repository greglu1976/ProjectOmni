...
\color{uniblue}{\section[(справочное) Перечень сигналов ФСУ, предназначенных для \\конфигурирования устройства ЮНИТ-М300-ДЗТ2]{(справочное)\\Перечень сигналов ФСУ, предназначенных для конфигурирования устройства ЮНИТ-М300-ДЗТ2}\label{app:signals}}
\color{black}
...
\hline
\rowcolor{gray!15} 
\multicolumn{9}{c}{Максимальная токовая защита (ДЗ)} \\
\hline
...
\multicolumn{9}{c}{\textbf{Системные сигналы (СИСТ) устройства}} \\
\hline
\rowcolor{gray!15} 
