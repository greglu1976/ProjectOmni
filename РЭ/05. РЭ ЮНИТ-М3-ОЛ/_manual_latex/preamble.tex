\documentclass[a4paper, 12pt,table, hidelinks]{extarticle} % что то меняется , не понятно article or extarticle...
...
\usepackage{graphicx}
%\usepackage{svg}
\usepackage{lmodern} % ПРОВЕОИТЬ НЕОБХОДТМОСТЬ В М300-ТН И УБРАТЬ!!!!
