...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[unired, very thick] (9.13+\aDelta, 4.1) -- (9.13+\aDelta, 1.35) -- (\dCoord, 1.35); % Новые координаты
\end{tikzpicture}
...
\begin{flushleft}
    ...
    \begin{tabular}{|p{6.2cm}|p{2.1cm}|}
        \hline
        \rowcolor{uniblue} % Синий цвет с прозрачностью
        \multicolumn{2}{|l|}{\textcolor{white}{Модуль в слоте М9...M11}} \\ % Объединение ячеек
        \hline
        Нет модуля & Х \\ 
        \hline
        Модуль дискретных входов    & B001,B021 \\
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[uniblue, very thick] (14.71+\aDelta, 5.7) -- (14.71+\aDelta, 1.35) -- (\dCoord, 1.35);
    \draw[uniblue, very thick] (15.46+\aDelta, 5.7) -- (15.46+\aDelta, 1.35) -- (\dCoord, 1.35);
    \draw[uniblue, very thick] (16.31+\aDelta, 5.7) -- (16.31+\aDelta, 1.35) -- (\dCoord, 1.35);     
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[unired, very thick] (17.05+\aDelta, 8.5) -- (17.05+\aDelta, 2.65) -- (\dCoord, 2.65); % Новые координаты
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[uniblue, very thick] (17.85+\aDelta, 13.4) -- (17.85+\aDelta, 4.65) -- (\dCoord, 4.65); % Новые координаты
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[unired, very thick] (18.5+\aDelta, 14.25) -- (18.5+\aDelta, 0.7) -- (\dCoord, 0.7); % Новые координаты
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[uniblue, very thick] (19.05+\aDelta, 15.15) -- (19.05+\aDelta, 0.6) -- (\dCoord, 0.6); % Новые координаты
\end{tikzpicture}
