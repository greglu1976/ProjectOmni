...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[uniblue, very thick] (17.3+\aDelta, 7.0) -- (17.3+\aDelta, 2.65) -- (\dCoord, 2.65); % Новые координаты
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[unired, very thick] (18.55+\aDelta, 12.0) -- (18.55+\aDelta, 4.65) -- (\dCoord, 4.65); % Новые координаты
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[uniblue, very thick] (19.1+\aDelta, 12.8) -- (19.1+\aDelta, 0.7) -- (\dCoord, 0.7); % Новые координаты
\end{tikzpicture}
...
% Начинаем TikZ
\begin{tikzpicture}[overlay]
    \draw[unired, very thick] (19.65+\aDelta, 13.6) -- (19.65+\aDelta, 0.6) -- (\dCoord, 0.6); % Новые координаты
\end{tikzpicture}
