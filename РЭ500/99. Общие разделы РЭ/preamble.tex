...
\usepackage{xcolor}
\definecolor{unimain}{RGB}{14, 75, 142}
...
\fancypagestyle{plain}{%
  ...
  \renewcommand{\headrule}{{\color{unimain}\hrule height \headrulewidth}}%
  \renewcommand{\footrule}{{\color{unimain}\hrule height \footrulewidth}}%
...
% ---------------------- Общее для РЭ ----------------------
\def\OKPD{Код ОКПД-2: 27.12.23.190} % УТОЧНЕНО Морозовым М. 30.03.26
\def\TNVED{Код ТН ВЭД: 8537 10 980 0} % УТОЧНЕНО Морозовым М. 30.03.26
